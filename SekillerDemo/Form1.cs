...
namespace SekillerDemo
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            panel2.Size = new Size(246, 105);
            panel2.Location = new Point(17, 88);
        }
        ...
        private void Hesapla()
        {
            ...
            else
            {
                _daire = new Daire()
                {
                    Yaricap = Convert.ToDouble(tbYaricap.Text),
                    PiUcMu = cbPi.Checked
                };
                tbSonuc.Text = rbAlan.Checked ? _daire.AlanHesapla().ToString() : _daire.CevreHesapla().ToString(); 
            }
        }
        ...
        private bool ValideEt()
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Yarýçap giriniz!", "Hata!", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
                    return false;
                }
                double yariCap;
                if (!double.TryParse(tbYaricap.Text.Trim(), out yariCap))
                {
                    MessageBox.Show("Yarýçap sayýsal olmalýdýr!", "Hata!", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
                    return false;
                }
            }
            return true;
